# Generated by Django 3.0.8 on 2020-07-21 07:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_status', models.CharField(default='Not Assigned', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Warnings',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('decision', models.CharField(choices=[('Support', 'Support'), ('Reject', 'Reject')], max_length=255)),
