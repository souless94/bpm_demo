...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='question',
            name='question_text',
            field=models.ForeignKey(blank=True, max_length=200, on_delete=django.db.models.deletion.CASCADE, to='the_process.QuestionAdder', to_field='question_text'),
        ),
        migrations.AddField(
            model_name='question',
            name='stepStatus',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='the_process.StepStatus'),
        ),
        migrations.CreateModel(
